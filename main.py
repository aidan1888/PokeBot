...
async def help(ctx):
    ...
    + " - Check your Pokedex and your collection progress\n3.\t!shinydex - Check your shiny Pokedex and your collection progress/n4.\t!have + argument - Check if you have a specific Pokemon by typing the command followed by the name of the Pokemon/n5.\t!shiny + argument - Check if you have a specific shiny Pokemon by typing the command followed by the name of the Pokemon")
